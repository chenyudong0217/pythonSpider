...
CREATE TABLE `account_table` (
  ...
  `is_login` int(11) DEFAULT NULL COMMENT '是否登录，cookie是否可用',
  `user_type` int(11) NOT NULL COMMENT '用户类型 1:VIP账户，2:普通用户',
  `last_login_time` datetime DEFAULT NULL COMMENT '上次登录时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='北大法宝账号表';
...
CREATE TABLE `cookie_table` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cookie_type` int(11) NOT NULL COMMENT '1:vip/2:个人cookie',
  `www_cookie` text COLLATE utf8mb4_unicode_ci,
  `login_time` datetime DEFAULT NULL COMMENT '登录时间',
  `user_id` int(11) DEFAULT NULL COMMENT '账号id',
  `m_cookie` text COLLATE utf8mb4_unicode_ci COMMENT 'm站cookie',
  `cas_cookie` text COLLATE utf8mb4_unicode_ci COMMENT '登录中间态cookie',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='账号cookie资源表';
...
CREATE TABLE `law_id_table` (
  ...
  `is_crawled` int(11) DEFAULT NULL COMMENT '是否采集',
  PRIMARY KEY (`law_id`)
